...
|
 Dynamic, single-page client interface 
|
|
**
Styling
...
|
 Tailwind CSS 
|
 Sleek, modern, and mobile-first layout 
|
|
**
Blockchain
...
|
 Low gas fee EVM chain (Chain ID: 
`80002`
) 
|
|
...
|
 Solidity, Hardhat 
|
 Escrow and Factory contract development 
|
|
**
Web3 Library
...
|
 Ethers.js v6 
|
 Provider connections and contract execution 
|
|
**
Wallet Connector
...
|
 Decentralized user wallet authentication 
|
|
**
Notifications
...
|
 Custom Context Hook 
|
 Multi-category client notifications system 
|
|
**
Icons
...
|
 Lucide React 
|
 Modern, customizable vector iconography 
|
---
## 🚀 Getting Started
### Prerequisites
